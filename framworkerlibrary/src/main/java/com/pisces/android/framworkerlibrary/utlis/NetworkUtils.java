 ...
 *
 * @author Jam
 *         create at 2016/5/19 15:12
 */
public class NetworkUtils {

    public enum NetType{
        G2,G3,G4,WIFI,UNKNOWN,NO
    }
    ...
    public static NetType getNetworkType(Context context) {
        NetType strNetworkType = NetType.NO;
            ...
            if (networkInfo.getType() == ConnectivityManager.TYPE_WIFI) {
                ...
                switch (networkType) {
                    ...
                    case TelephonyManager.NETWORK_TYPE_HSPAP:  //api<13 : replace by 15
                        strNetworkType = NetType.G3;
                        break;
                    case TelephonyManager.NETWORK_TYPE_LTE:    //api<11 : replace by 13
                        strNetworkType = NetType.G4;
                        break;
                    default:
                        ...
                        if (_strSubTypeName.equalsIgnoreCase("TD-SCDMA") || _strSubTypeName.equalsIgnoreCase("WCDMA") || _strSubTypeName.equalsIgnoreCase("CDMA2000")) {
                            ...
                            strNetworkType = NetType.UNKNOWN;
                        }
...
//        Log.e("cocos2d-x", "Network Type : " + strNetworkType.name());
