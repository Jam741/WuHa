...
//裁剪界面
public class CropperImageRectangleActivity extends BaseActivity {
	...
	protected Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 0x111) {
				...
				String path=ImageUtils.saveAsBitmap(CropperImageRectangleActivity.this, itbmp, Constants.folderName, null);
				itbmp.recycle();
