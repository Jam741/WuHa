...
public class FilterUtils {
	...
	public static ArrayList<Filter_Effect_Info> getEffectList(){
		...
		effect_list.add(new Filter_Effect_Info("原图", R.drawable.btn_back,FilterType.I_1977));
		effect_list.add(new Filter_Effect_Info("创新", R.drawable.btn_back,FilterType.I_1977));
		effect_list.add(new Filter_Effect_Info("流年", R.drawable.btn_back,FilterType.I_AMARO));
		effect_list.add(new Filter_Effect_Info("淡雅", R.drawable.btn_back,FilterType.I_BRANNAN));
		effect_list.add(new Filter_Effect_Info("怡尚", R.drawable.btn_back,FilterType.I_EARLYBIRD));
		effect_list.add(new Filter_Effect_Info("优格", R.drawable.btn_back,FilterType.I_HEFE));
		effect_list.add(new Filter_Effect_Info("胶片", R.drawable.btn_back,FilterType.I_HUDSON));
		effect_list.add(new Filter_Effect_Info("黑白", R.drawable.btn_back,FilterType.I_INKWELL));
		effect_list.add(new Filter_Effect_Info("个性", R.drawable.btn_back,FilterType.I_LOMO));
		effect_list.add(new Filter_Effect_Info("回忆", R.drawable.btn_back,FilterType.I_LORDKELVIN));
		effect_list.add(new Filter_Effect_Info("不羁", R.drawable.btn_back,FilterType.I_NASHVILLE));
		effect_list.add(new Filter_Effect_Info("森系", R.drawable.btn_back,FilterType.I_NASHVILLE));
		effect_list.add(new Filter_Effect_Info("清新", R.drawable.btn_back,FilterType.I_SIERRA));
		effect_list.add(new Filter_Effect_Info("摩登", R.drawable.btn_back,FilterType.I_SUTRO));
		effect_list.add(new Filter_Effect_Info("绚丽", R.drawable.btn_back,FilterType.I_TOASTER));
		effect_list.add(new Filter_Effect_Info("优雅", R.drawable.btn_back,FilterType.I_VALENCIA));
		effect_list.add(new Filter_Effect_Info("日系", R.drawable.btn_back,FilterType.I_WALDEN));
		effect_list.add(new Filter_Effect_Info("新潮", R.drawable.btn_back,FilterType.I_XPROII));
