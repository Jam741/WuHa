...
public class CameraSdkParameterInfo implements Serializable {
    ...
    private boolean croper_image_rectangle = false; //剪裁成矩形

    public boolean isCroper_image_rectangle() {
        return croper_image_rectangle;
    }

    public void setCroper_image_rectangle(boolean croper_image_rectangle) {
        this.croper_image_rectangle = croper_image_rectangle;
        this.croper_image = true;
    }
